import { Box, Button, CardActions, CardContent, CardMedia, colors, ImageList, ImageListItem, Typography } from '@mui/material';
...
const itemData: ImageCareerItem[] = [
    {
        ...
        descripcion: 'Curso en el area de ELECTRONICA INSDUSTRIAL con estadares insdustriales a nivel global.'
    },
    {
        id: '2',
        img: electricidad,
        title: 'Electricidad Industrial',
        descripcion: 'Curso en el area de ELECTRICIDAD INSDUSTRIAL con estadares insdustriales a nivel global.'
    },
    {
        id: '3',
        img: tics,
        title: 'Desarrollo de Software ',
        descripcion: 'Curso en el area de DESARROLO DE SOFTWARE con estadares insdustriales a nivel global.'
    },
    {
        id: '4',
        img: mecanica,
