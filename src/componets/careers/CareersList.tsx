    ...
    const fetchCareers = () => {
        setTimeout(() => {
            const data = [
                {
                    carreraId: 1,
                    nombre: 'Desarrollo de aplicaciones moviles android'
                },
                {
                    carreraId: 2,
                    nombre: 'Desarroadpr FullStack en Java EEE & React'
                },
                {
                    carreraId: 3,
                    nombre: 'Desarroadpr FullStack con DontCore 9 & Angular'
                },
                {
                    carreraId: 4,
                    nombre: 'Desarrollo de aplicaciones moviles Swift'
                },
                {
                    carreraId: 5,
